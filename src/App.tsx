    ...
    return (
        <div className="flex flex-col">
            ...
            {acceptedFile && downloadLink &&
                ...
                //     {}
                // </div>
                <a href={downloadLink} download={`Schedule.ics`} className="flex flex-grow border self-center bg-darkgreen rounded-lg p-2 sm:p-3 px-4 sm:px-7 text-white text-sm sm:text-xl text-center drop-shadow-lg">Download</a>
            }
